...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.7, -- Basic efficiency for taxes without 'crats and tech
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.2,
	GOLD_TO_CASH_RATE = 0.2, -- Amount of money generated per gold unit
	...
	CAMPAIGN_EVENT_BASE_TIME = 63, -- once every 7 weeks.
	CAMPAIGN_EVENT_MIN_TIME = 35 ,-- never more often than 5 weeks between
	...
	PROVINCE_OVERSEAS_PENALTY = 0.1, -- Each province req. this many goods flagged as overseas penalty 
	NONCORE_TAX_PENALTY = -0.01, -- -5% for each non-core in state
	...
	COLONIZATION_DAYS_FOR_INITIAL_INVESTMENT = 540,
	...
	COLONIZATION_COLONY_RAILWAY_MAINTAINANCE = 0.2,
	...
	COLONIZATION_CREATE_STATE_COST = 500,
...
economy = {
	...
	BANKRUPTCY_EXTERNAL_LOAN_YEARS	= 2000,
...
military = {
	...
	AI_BIGSHIP_PROPORTION = 0.35, -- fraction of ships in the navy that should be ships of the line
	...
	AI_BLOCKADE_RANGE = 3000, -- max distance the AI will send out blockade fleets from their home base
	...
	SIEGE_BRIGADES_MIN = 1, -- the number of brigades needed for a siege to progress at normal speed (1 - aikidopanda)
	SIEGE_BRIGADES_MAX = 13, -- the number of brigades above which you get no addition benefit in sieges (13 - aikidopanda)
	...
	SIEGE_ATTRITION = 0.5, -- fixed attrition on sieging units
...
diplomacy = {
	...
	WAR_PRESTIGE_COST_HONOR_ALLIANCE = -15,
	WAR_PRESTIGE_COST_HONOR_GUARANTEE = -5,
	...
	CALLALLY_RELATION_ON_ACCEPT = 25,
	...
	CRISIS_COOLDOWN_MONTHS = 36,
	CRISIS_BASE_CHANCE = 10,
	CRISIS_TEMPERATURE_INCREASE = 0.06,
...
ai =
{
	...
	SOLDIER_WEIGHT = 4.5, -- ai weight for soldiers
	...
	PRODUCTION_WEIGHT = 0.6, -- ai weight for new production
	...
	PEACE_WAR_EXHAUSTION_FACTOR = 0.3, -- AI willingness to peace based on war exhaustion
	PEACE_WAR_DIRECTION_FACTOR = 1.1, -- AI willingness to peace based on who's making gains in the war
